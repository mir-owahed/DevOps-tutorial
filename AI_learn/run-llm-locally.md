...
```
876  sudo docker volume create ollama_data
  ...
  889  docker run -d -p 3000:8080 --add-host=host.docker.internal:host-gateway -v open-webui:/app/backend/data --name open-webui --restart always ghcr.io/open-webui/open-webui:main
  890  curl http://localhost:11434/api/generate -d '{
  "model": "llama3.2",
  "prompt":"Why is the sky blue?"
}'
  891  curl http://localhost:11434/api/generate -d '{
  "model": "llama3.2:1:1b",
  "prompt":"Why is the sky blue?"
}'
  892  curl http://localhost:11434/api/generate -d '{
  "model": "llama3.2:1b",
  "prompt":"Why is the sky blue?"
}'
  893  history
